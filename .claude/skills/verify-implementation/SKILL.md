...
|---|-------|------|---------|-----|
| 1 | verify-<name1> | `path/to/file.py:42` | Problem description | Fix code example |
| 2 | verify-<name2> | `path/to/file.py:15` | Problem description | Fix code example |
```
...
- [1/X] verify-<name1>: `path/to/file.py` fixed
- [2/X] verify-<name2>: `path/to/file.py` fixed
...
| # | Skill | File | Problem |
|---|-------|------|---------|
| 1 | verify-<name> | `path/to/file.py:42` | Cannot auto-fix — manual review required |
